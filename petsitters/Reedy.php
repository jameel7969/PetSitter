...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="ReedyProfiePic"></div>

    <div>
      <h3 id="userName"">Reedy Holmes</h3>
        <p id="description">Greetings, I'm Reedy! Growing up surrounded by pets, I developed a deep understanding of
        their needs and behaviors. As your pet sitter, I provide a safe and nurturing environment, ensuring your furry
        companions feel right at home.</p>

        <a href="../BookingPage.php?petsitter=Reedy" class="callToAction" id="Hire">
          Hire Now
        </a>
