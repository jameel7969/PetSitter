...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="StarcProfiePic"></div>

    <div>
      <h3 id="userName">Starc Jones</h3>
      <p id="description">Hey there, I'm Starc! With a playful spirit and a genuine love for animals, I offer pet
        sitting services filled with fun and joy. From leisurely strolls to engaging play sessions, I tailor each
        experience to suit your pet's unique personality.</p>

        <a href="../BookingPage.php?petsitter=Starc" class="callToAction" id="Hire">
          Hire Now
        </a>
