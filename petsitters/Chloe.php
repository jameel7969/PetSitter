...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="ChloeProfiePic"></div>

    <div>
      <h3 id="userName">Chloe White</h3>
      <p id="description" editable="true">Hello, I'm Chloe! With a background in animal behavior and a keen eye for
        detail, I provide attentive and personalized pet care services. From daily walks to enrichment activities, I
        ensure your pets stay happy, healthy, and entertained in your absence.</p>

      <!-- <a href="#" class="callToAction" id="isCholeHired"> -->
        <a href="../BookingPage.php?petsitter=Chloe" class="callToAction" id="Hire">
        Hire Now
      </a>
