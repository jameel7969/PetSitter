...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="JasonProfiePic"></div>

    <div>
      <h3 id="userName">Jason Brody</h3>
      <p id="description">Hi, I'm Jason! As a dedicated pet owner and experienced pet sitter, I know the importance of
        trust and reliability when it comes to caring for your beloved pets. Rest assured, I'll treat your furry friends
        like family, providing them with the utmost care and attention</p>

      <!-- <a href="#" class="callToAction" id="isJasonHired"> -->
        <a href="../BookingPage.php?petsitter=Jason" class="callToAction" id="Hire">
        Hire Now
      </a>
