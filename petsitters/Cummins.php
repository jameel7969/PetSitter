...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="CumminsProfiePic"></div>

    <div>
      <h3 id="userName">Cummins Elliot</h3>
      <p id="description">Hello, I'm Cummins! With a warm heart and a friendly demeanor, I provide reliable and
        attentive pet sitting services. Your pets will feel right at home under my care, receiving plenty of love,
        playtime, and cuddles while you're away.</p>

      <!-- <a href="#" class="callToAction" id="isCumminsHired"> -->
        <a href="../BookingPage.php?petsitter=Cummins" class="callToAction" id="Hire">
        Hire Now
      </a>
