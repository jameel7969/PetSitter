...
<body>
  ...
  <section style="margin-bottom: 200px;">
    <div id="TashaProfiePic"></div>

    <div>
      <h3 id="userName">Tasha Gray</h3>
      <p id="description">Hi, I'm Tasha! With a nurturing nature and a heart full of love for animals, I offer pet
        sitting services that prioritize your pet's comfort and happiness. Whether it's snuggles on the couch or outdoor
        adventures, your pets will receive the TLC they deserve.</p>

        <a href="../BookingPage.php?petsitter=Tasha" class="callToAction" id="Hire">
          Hire Now
        </a>
